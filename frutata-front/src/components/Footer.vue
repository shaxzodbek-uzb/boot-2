    ...
    <div class="container">
      <div id="agustd" class="row">
        <div class="col-xs-4 col-sm-4 col-md-2 col-lg-2 col-xl-2" id="loona">
          <img class="likey" src="@/assets/logo/frutatalogowhite.png" alt="" />
        </div>
        <div class="col-xs-4 col-sm-4 col-md-2 col-lg-2 col-xl-2" id="loona">
        ...
        <div class="col-xs-4 col-sm-4 col-md-2 col-lg-2 col-xl-2" id="loona">
          ...
          <a href="#" class="foot__txt"
            >Махалля Файзабад, улица, Fargona Road</a
          >
        </div>
        <div class="col-xs-4 col-sm-4 col-md-2 col-lg-2 col-xl-2" id="loona">
        ...
        <div class="col-xs-4 col-sm-4 col-md-2 col-lg-2 col-xl-2" id="loona">
          ...
          <div class="socs2 d-flex">
            <a class="nav-link ps-0" href="#"
              ><i style="color: #689e00" class="fab fa-instagram"></i
            ></a>
            <a class="nav-link" href="#"
              ><i style="color: #689e00" class="fab fa-facebook-f"></i
            ></a>
            <a class="nav-link" href="#"
              ><i style="color: #689e00" class="fab fa-youtube"></i
            ></a>
          </div>
        </div>
      </div>
