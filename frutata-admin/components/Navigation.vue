          ...
          <div class="hidden sm:block sm:ml-6">
            <div class="flex space-x-4">
              ...
              <nuxt-link
                ...
                :key="key"
                :to="resource.routes.list"
                class="px-3 py-2 rounded-md text-sm font-medium"
                aria-current="page"
                :class="{ 'bg-gray-900 text-white':(active == resource.name_cebab),
                          'text-gray-300 hover:bg-gray-700 hover:text-white':!(active == resource.name_cebab)
                }"
              >{{ resource.label }}</nuxt-link>
            </div>
          </div>
        </div>
        <div
